      ...
      *> the following *MAY* be dropped in favor of [LIST/GET+] SET and
      *> are for now disabled by default
       >> IF OLD-GCWINDOW-ABI IS DEFINED
      *> move the window
      ...
      *> secondary parameter block for all commands but WP-WINDOW-LIST
      *> containing definitions
       01  WP-WINDOW-PARMS.
           03  WP-WINDOW-NUMBER         USAGE BINARY-SHORT UNSIGNED.
           03  WP-WINDOW-ATTRIBUTES.
               05  WP-WINDOW-START-LINE  USAGE BINARY-SHORT UNSIGNED.
               05  WP-WINDOW-START-COL   USAGE BINARY-SHORT UNSIGNED.
               05  WP-WINDOW-LINES       USAGE BINARY-SHORT UNSIGNED.
               05  WP-WINDOW-COLUMNS     USAGE BINARY-SHORT UNSIGNED.
               05  WP-WINDOW-FG-COLOR    USAGE BINARY-SHORT UNSIGNED.
               05  WP-WINDOW-BG-COLOR    USAGE BINARY-SHORT UNSIGNED.
               05  WP-WINDOW-FLAGS       USAGE BINARY-SHORT UNSIGNED.
      ...
      *> convenience variable for possible call after SET WP-MODE-...
       ...
       >> IF NEW-GCWINDOW-ABI IS DEFINED
           88  WP-MODE-GET               VALUE WP-WINDOW-GET-ATTRIBUTES.
           88  WP-MODE-SET               VALUE WP-WINDOW-SET-ATTRIBUTES.
       >> ELSE
      ...
      *> type for elements in communication area (secondary parameter)
      *> for command WP-WINDOW-LIST to retrieve information about windows
      *> created, including the windows currently hidden;
      *> the visible/active ones will be in order of their depth within
      *> the visible window-stack;
      *> elements that are complete empty (low values) represent the end
      *> of used elements, which may be checked by WL-WINDOW-UNUSED
      *>
      *> sample definition for the communication area using this type:
      *>
       01  WL-WINDOW-ELEMENT-TYPE                TYPEDEF.
               88  WL-WINDOW-UNUSED              VALUE ALL LOW-VALUE.
           03  WL-DEPTH                    USAGE BINARY-SHORT UNSIGNED.
           03  WL-WINDOW-PARMS.
               05  WL-WINDOW-NUMBER        USAGE BINARY-SHORT UNSIGNED.
               05  WL-WINDOW-ATTRIBUTES    USAGE BINARY-SHORT UNSIGNED.
                   10  WL-WINDOW-POSITION-LINE.
                   10  WL-WINDOW-POSITION-COL.
                   10  WL-WINDOW-SIZE-LINES.
                   10  WL-WINDOW-SIZE-COLS.
                   10  WL-WINDOW-FG-COLOR.
                   10  WL-WINDOW-BG-COLOR.
                   10  WL-WINDOW-FLAGS.

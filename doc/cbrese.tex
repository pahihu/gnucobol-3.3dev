...
@item @code{MENU} @tab Yes	(C/S) @tab 
...
@item @code{MODAL} @tab Yes	(C/S) @tab 
@item @code{MODE} @tab Yes @tab 
@item @code{MODELESS} @tab Yes	(C/S) @tab 
...
@item @code{SYMBOL} @tab Yes	(C/S) @tab 
...
@item @code{TRACE} @tab Yes	(C/S) @tab 
